...
def signal(*args):
    # V1Up indicator (V1 upper adaptive Bollinger band distance)
    ...
    #          UP1 = MEDIAN + STD * M1; V1Up = UP1 - V1
    # Measures how far the V1 composite is below its adaptive upper Bollinger band.
    # Positive values mean V1 is below the upper band; negative means it has broken above (overbought signal).
    df = args[0]
    n = args[1]
    factor_name = args[2]
